...
if __name__ == "__main__":
    ...
    data_transforms = {
        'train': Compose([RandomResizedCrop(299),  # 224 for alexnet and resnet18 / 299 for inception v3
                          RandomHorizontalFlip(),
                          ToTensor()]),
        'val': Compose([Resize(256),
                        CenterCrop(299),  # 224 for alexnet and resnet18 / 299 for inception v3
                        ToTensor()]),
    ...
    model_ft = inception_v3(
        weights='IMAGENET1K_V1')  # resnet18(weights='IMAGENET1K_V1')      #alexnet(weights='IMAGENET1K_V1')
    model_ft.aux_logits = False

    num_ftrs = model_ft.fc.in_features  # for resnet and inception

    # num_ftrs = model_ft.classifier[-1].in_features  # for alexnet
